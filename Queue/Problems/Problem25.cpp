...
// Time Complexity: O(N + E) where N is the total number of cells on the board and E is the total number of edges in the graph.
// Space Complexity: O(N) where N is the total number of cells on the board.